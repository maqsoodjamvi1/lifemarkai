    ...
    <CommandDialog open={open} onOpenChange={setOpen}>
      ...
      <CommandList>
        ...
        <CommandGroup heading="Navigation">
          ...
          <CommandItem onSelect={() => run(() => navigate({ to: "/dashboard/analytics" }))}>
            <BarChart3 className="mr-2 h-4 w-4" />
            Analytics
          </CommandItem>
          <CommandItem onSelect={() => run(() => navigate({ to: "/dashboard/team" }))}>
            <Users className="mr-2 h-4 w-4" />
            Team
          </CommandItem>
          <CommandItem onSelect={() => run(() => navigate({ to: "/dashboard/billing" }))}>
            <CreditCard className="mr-2 h-4 w-4" />
            Billing
          </CommandItem>
          <CommandItem onSelect={() => run(() => navigate({ to: "/dashboard/settings" }))}>
        ...
        <CommandGroup heading="Actions">
          <CommandItem onSelect={() => run(() => navigate({ to: "/dashboard", search: { new: "true" } as never }))}>
