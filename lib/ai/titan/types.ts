/**
 * Project Titan AI v2.0 — core types for the multi-agent "software company".
 * See docs/titan/01-ai-software-company.md and docs/titan/06-database-schema.md.
 *
...
/** The ten standing roles + the CTO review persona. */
...
export interface InitiativeOptions {
   ...
   * agent.ts ReAct loop (the full 10-tool agent) so Titan agents actually read,
