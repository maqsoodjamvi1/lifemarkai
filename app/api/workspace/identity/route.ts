...
/** GET/PATCH /api/workspace/identity — SSO + SCIM workspace settings. */
export async function GET() {
  ...
  return NextResponse.json({
    ...
    scim: scim
      ? {
          ...scim,
          apiKeyPrefix: data?.scim_api_key_prefix ?? null,
        }
      : null,
    enforceSettings: {
...
export async function PATCH(req: NextRequest) {
  ...
  const needsScim =
    body.scim !== undefined || body.rotateScimKey || body.disableScim;
