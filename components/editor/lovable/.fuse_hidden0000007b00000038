  ...
  return (
    <div className="mx-3 mb-2 px-3 py-2.5 rounded-[var(--radius-3)] bg-amber-500/10 border border-amber-500/25 flex items-start gap-2.5 text-xs">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-amber-200/70 mt-0.5 font-mono text-[10px] truncate" title={top.message}>
          {summary}
        </p>
      </div>
      <button
        type="button"
        onClick={onFixWithAI}
        className="shrink-0 flex items-center gap-1 rounded-lg border border-amber-500/40 bg-amber-500/15 hover:bg-amber-500/25 text-amber-100 text-[11px] font-medium px-2.5 py-1 transition-colors"
      >
      ...
      {onDismiss && (
        <button
          type="button"
          onClick={onDismiss}
          className="shrink-0 p-1 rounded hover:bg-amber-500/15 text-amber-300/60 hover:text-amber-200 transition-colors"
          aria-label="Dismiss"
        >
