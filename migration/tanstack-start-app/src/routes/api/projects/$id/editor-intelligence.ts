...
async function handlePOST(req: Request, params: any) {
  try {
    ...
    if (body.action === "bootstrap") {
      ...
      return Response.json({ error: "Unknown action. Use bootstrap, message, or decision." }, { status: 400 });
    }
...
export const Route = createFileRoute("/api/projects/$id/editor-intelligence")({
  server: {
    handlers: {
