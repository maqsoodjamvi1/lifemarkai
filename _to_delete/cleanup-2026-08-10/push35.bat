@echo off
REM Push the hydration fix. Log goes to push35-result.txt.
setlocal
set "HERE=%~dp0"
set "BUNDLE=%HERE%lifemark-hydration.bundle"
set "LOG=%HERE%push35-result.txt"
set "WORK=%TEMP%\lm-push35"
set "BRANCH=codex/security-hardening"

> "%LOG%" 2>&1 (
  echo === LifemarkAI push35: SSR hydration fix ===
